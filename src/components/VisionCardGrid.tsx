      ...
      {cards.map((card, index) => {
        ...
        return (
          ...
          >
            ...
            >
              {/* Hover/active scale */}
              <div className="transition-transform duration-300 group-hover:scale-[1.03] group-active:scale-[0.97]">
                {/* Card: shadow + float + glow */}
                <div
                  className={`rounded-2xl overflow-hidden vision-card-shadow vision-card-float transition-shadow duration-500 relative ${card.pinned ? "vision-card-pinned" : ""}`}
                  style={{
                    "--card-glow": `${gradient.accent}40`,
                  ...
                  {hasImage ? (
                    ...
                    <>
                      ...
                      >
                        ...
                        <span
                          className="absolute top-2.5 left-3 text-[44px] leading-none font-serif select-none pointer-events-none opacity-[0.12]"
